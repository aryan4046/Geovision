...
export function Login() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-black via-[#0a0a1a] to-[#1a0a2e]">
        ...
        <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 mt-2">
              {isSignup ? "Create your account" : "GeoSpatial Site Readiness Analyzer"}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              {isSignup ? "Create Account" : "Login to GeoVision AI"}
            </Button>
          </form>
