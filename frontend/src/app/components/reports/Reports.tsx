...
import { ArrowLeft, Download, MapPin, TrendingUp, TrendingDown, Zap, BarChart3, Users, Map as MapIcon, Store } from "lucide-react";
          ...
          <div className="max-w-5xl mx-auto space-y-6 mt-8">
            ...
            <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-8">
              ...
              <p className="text-gray-300 mb-4">
                Based on comprehensive AI analysis, <span className="text-purple-400 font-semibold">{reportData.location}</span> is <span className="text-green-400 font-semibold">highly recommended</span> for your {reportData.businessType.toLowerCase()} business. The location scores exceptionally well (91/100) with outstanding accessibility and strong demographic indicators.
              </p>
              <p className="text-gray-300">
                While operational costs are higher, the consistent foot traffic from office workers and upcoming developments in the area present significant growth opportunities. We recommend proceeding with detailed site visit and lease negotiations.
              </p>
            </div>
